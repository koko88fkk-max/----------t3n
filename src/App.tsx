                ...
                >
                  ...
                  {!user && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={onLogin}
                      className="w-full mb-5 bg-white/5 border border-blue-500/30 rounded-2xl px-6 py-4 flex items-center justify-center gap-3 hover:bg-white/10 transition-all text-white font-bold"
                    >
